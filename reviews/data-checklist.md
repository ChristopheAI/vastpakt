...
Use this checklist for metrics, facts, claims, research notes, keyword data, and quantified statements.
...
- The review names the weakest unsupported claim before recommending improvements.
- Any recommendation explains which evidence supports it and which evidence is still missing.
